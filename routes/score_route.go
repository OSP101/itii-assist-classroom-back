...
func SetupScoreRoutes(app *fiber.App) {
	...
	ser.Post("/:id/approve", middlewares.RequireCourseAccess(middlewares.CourseIDFromScoreEditRequestParam("id"), "instructor", "ta"), middlewares.RequireCoursePermission(middlewares.CourseIDFromScoreEditRequestParam("id"), repositories.PermissionReviewAllScoreRequests, "instructor", "ta"), handlers.ApproveScoreEditRequestCompatHandler)
	ser.Post("/:id/reject", middlewares.RequireCourseAccess(middlewares.CourseIDFromScoreEditRequestParam("id"), "instructor", "ta"), middlewares.RequireCoursePermission(middlewares.CourseIDFromScoreEditRequestParam("id"), repositories.PermissionReviewAllScoreRequests, "instructor", "ta"), handlers.RejectScoreEditRequestCompatHandler)
