...
func SetupCourseActivityLogRoutes(app *fiber.App) {
	...
	group.Get("/", middlewares.AuditCourseView(services.ActionViewActivityLog, middlewares.CourseIDFromParam("courseId")), handlers.GetCourseActivityLogsHandler)
	group.Get("/export", middlewares.AuditCourseView(services.ActionExportActivityLog, middlewares.CourseIDFromParam("courseId")), handlers.ExportCourseActivityLogsHandler)
