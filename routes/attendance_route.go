...
func SetupAttendanceRoutes(app *fiber.App, auditLogger *services.AuditLogger) {
	...
	api.Get("/course-summary", middlewares.RequireCourseAccess(middlewares.CourseIDFromQuery("course_id"), "instructor", "ta"), middlewares.RequireCoursePermission(middlewares.CourseIDFromQuery("course_id"), repositories.PermissionViewAttendance, "instructor", "ta"), handlers.GetAttendanceCourseSummaryHandler)
