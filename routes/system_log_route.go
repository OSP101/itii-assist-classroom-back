...
func SetupSystemLogRoutes(api *fiber.App) {
	...
	logs.Use(middlewares.RequireAdminFeature("menu.logs"))
	...
	logs.Post("/cleanup", middlewares.RequirePrivilegedStepUp("system_logs.cleanup"), handlers.CleanupLogsHandler)
}
